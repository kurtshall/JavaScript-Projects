//create object to keep track of vlaues
const Calculator = {
    //this displays 0 on screen
    Display_Value: '0',
    //this will hold first operand for any expressions, set as null for now
    First_Operand: null,
    //this checks to see if second operand is selected or not
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand ===  true) {
        ...
        //overwrites Display_Value if the current value is )
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //saying that if the display_value does not contain a deciaml point
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exists and if Wait_Seocnd_operand is true,
